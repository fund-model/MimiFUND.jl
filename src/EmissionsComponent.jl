...
function init(s::emissions)    
    ...
    for r in d.regions 
        v.energint[t0, r] = 1
        v.energuse[t0, r] = p.gdp0[r]
        v.emissint[t0, r] = p.emissint0[r]
        v.emission[t0, r] = v.emissint[t0, r] / v.energuse[t0, r]
        v.ch4cost[t0, r] = 0
        v.n2ocost[t0, r] = 0
        v.ryg[t0, r] = 0
        v.reei[t0, r] = 0
    ...
    minint = Inf
    for r in d.regions 
        if v.emission[t0, r] / p.income[t0, r] < minint
            minint = v.emission[t0, r] / p.income[t0, r]
        end
    end
    # v.minint[t0] = minint
    v.minint[t0] = 0
